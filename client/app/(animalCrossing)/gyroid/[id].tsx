// app/animalCrossing/gyroids/[id].tsx
...
export default function GyroidDetailPage() {
  ...
  const customizable =
    (item as any)?.customizable != null
      ? String((item as any).customizable) === "true"
        ? "Yes"
        : "No"
      : null;
      ...
      {showMainSpinner ? (
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 28 }}>
          ...
          <View className="mt-3 px-1">
            ...
            <View className="mt-2">
              <Card>
                <StatRow label="Sound" value={sound} />
          ...
          <View className="mt-3 px-1">
            ...
            <View className="mt-2">
              <Card>
                ...
                <StatRow label="Cyrus Price" value={cyrus ? `${cyrus} Bells` : null} />
              </Card>
            </View>
          </View>
          ...
          {sound ? (
            <View className="mt-3 px-1">
              <SectionTitle>Related Sound</SectionTitle>
              <View className="mt-2">
                <Card>
                  <Text className="text-[11px] text-slate-400">Same sound: {sound}</Text>

                  {related.length === 0 ? (
                    <Text className="mt-2 text-[11px] text-slate-600">No related gyroids found.</Text>
                  ) : (
