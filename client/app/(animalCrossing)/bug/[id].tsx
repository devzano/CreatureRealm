...
function AvailabilitySection({
  ...
  const hasAny =
    !!months || ranges.length > 0 || (timesByMonth && Object.keys(timesByMonth).length > 0);
...
export default function BugDetailPage() {
      ...
      try {
        ...
        if (myLoc) {
          ...
          try {
            ...
            const me = String((fetched as any)?.name ?? bugName).trim().toLowerCase();
  ...
  const showMainSpinner = loading || relatedLoading;
      ...
      {showMainSpinner ? (
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 28 }}>
          ...
          <View className="mt-3 px-1">
            ...
            <View className="mt-2">
              <Card>
                ...
                <StatRow label="Weather" value={weather} />
          ...
          <View className="mt-3 px-1">
            ...
            <View className="mt-2">
              <Card>
                ...
                <StatRow label="Sell (Flick)" value={sellFlick ? `${sellFlick} Bells` : null} />
              </Card>
            </View>
          </View>
          ...
          <View className="mt-3 px-1">
            ...
            <View className="mt-2">
              <Card>
                <AvailabilitySection title="Northern Hemisphere" data={(bug as any)?.north} />
                <AvailabilitySection title="Southern Hemisphere" data={(bug as any)?.south} />
              </Card>
            </View>
          </View>
            ...
            <View className="mt-3 px-1">
              ...
              <View className="mt-2">
                <Card>
                  ...
                  {related.length === 0 ? (
                    <Text className="mt-2 text-[11px] text-slate-600">No related bugs found.</Text>
                  ) : (
                    <View className="mt-2 flex-row flex-wrap">
                      {related.map((r, idx) => {
