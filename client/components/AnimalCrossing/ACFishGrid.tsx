...
const FishTile: React.FC<FishTileProps> = React.memo(
...
const ACFishGrid: React.FC<ACFishGridProps> = ({ search }) => {
  ...
  const headerLine = useMemo(() => {
    return `Showing ${grid.visibleNames.length} / ${grid.filteredNames.length} fish${
