...
export type PaldeckEntryStripProps = {
  ...
  element?: string | null; // OPTIONAL: pass the pal's element so "Caught" can use elementHex
};

export const PaldeckEntryStrip: React.FC<PaldeckEntryStripProps> = ({ dexId, element }) => {
  ...
  const CAUGHT_COLOR = element ? elementHex(element) : "#f97316";
  const LUCKY_COLOR = "#0cd3f1";
