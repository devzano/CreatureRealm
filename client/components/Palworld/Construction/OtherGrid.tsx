...
const stripTrailingOther = makeStripTrailingSuffix(/\s*other\s*$/i);
...
export default function PalOtherGrid({
  ...
  const { visible: sheetVisible, open: openSheet, close: closeSheet, selected, detail, loading, error } =
    useDetailSheet<OtherIndexItem, OtherDetail>(fetchOtherDetail, onPressItem);
