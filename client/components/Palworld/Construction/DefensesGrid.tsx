...
import {
  fetchDefensesDetail,
  type DefensesIndexItem,
  type DefensesDetail,
} from "@/lib/palworld/construction/paldbDefenses";
...
const stripTrailingDefenses = makeStripTrailingSuffix(/\s*defenses?\s*$/i);
...
export default function PalDefensesGrid({
  ...
  const { visible: sheetVisible, open: openSheet, close: closeSheet, selected, detail, loading, error } =
    useDetailSheet<DefensesIndexItem, DefensesDetail>(fetchDefensesDetail, onPressItem);
