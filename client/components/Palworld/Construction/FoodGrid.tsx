...
import { DescriptionSection, DependencyTreeSection, RecipeSection, SheetLabel } from "@/components/Palworld/Construction/palSheetSections";
...
const stripTrailingFood = makeStripTrailingSuffix(/\s*food\s*$/i);
...
export default function PalFoodGrid({
  ...
  const { visible: sheetVisible, open: openSheet, close: closeSheet, selected, detail, loading, error } =
    useDetailSheet<FoodIndexItem, FoodDetail>(fetchFoodDetail, onPressItem);
