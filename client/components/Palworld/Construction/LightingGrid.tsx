...
import {
  fetchLightingDetail,
  type LightingIndexItem,
  type LightingDetail,
} from "@/lib/palworld/construction/paldbLighting";
...
const stripTrailingLighting = makeStripTrailingSuffix(/\s*lighting\s*$/i);
...
export default function PalLightingGrid({
  ...
  const { visible: sheetVisible, open: openSheet, close: closeSheet, selected, detail, loading, error } =
    useDetailSheet<LightingIndexItem, LightingDetail>(fetchLightingDetail, onPressItem);
